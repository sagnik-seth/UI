 ...
 const Home =({ navigation }) => {
   return(
     <View style={{ alignItems: 'center',backgroundColor: '#abf7ee',flex:1}}> 
       <Image source={{uri:"https://images.unsplash.com/photo-1631040934414-d6cb790165b2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1587&q=80"}}
       style={{
       width: 300,
       height: 400,
       marginTop: 20,
   ...
   return(
     <ScrollView style={{backgroundColor: '#abf7ee',alignSelf: 'center'}}>
       ...
       alignSelf: 'center'
        ...
        Engine:- 1340 cc(Liquid-cooled, FI)
        </Text>
        <Text style={styles.Text}>
        Cylinder:- 4  (inline)
        </Text>
